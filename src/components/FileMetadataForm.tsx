        ...
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="Nama acara, misal: Rapat Koordinasi 2026"
          ...
          <div className="space-y-1.5">
            <label className="flex items-center gap-2 text-xs font-medium text-foreground">
              ...
              Divisi / Organisasi <span className="text-destructive">*</span>
            </label>
            <Input
              value={metadata.divisi}
              onChange={(e) => updateMetadata("divisi", e.target.value.slice(0, 100))}
              placeholder="Nama divisi atau organisasi"
              className="h-9 text-sm"
              maxLength={100}
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              placeholder="Deskripsi singkat tentang file-file ini..."
              className="text-sm min-h-[80px] resize-none"
              maxLength={300}
            />
            <p className="text-xs text-muted-foreground">{metadata.description.length}/300 karakter</p>
          </div>
        </div>
      </ScrollArea>
      ...
      <div className="p-4 border-t border-border bg-muted/20 shrink-0">
        ...
        {!isFormValid && (
          <p className="text-xs text-muted-foreground text-center mt-2">
            Lengkapi semua field untuk memulai
          </p>
        )}
      </div>
    </div>
